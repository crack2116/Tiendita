...
export default function Hero() {
  return (
    <section className="border-b border-border bg-[radial-gradient(800px_400px_at_10%_10%,rgba(249,115,22,.25),transparent_55%),radial-gradient(700px_350px_at_90%_0%,rgba(245,158,11,.25),transparent_60%)]">
      <div className="container grid md:grid-cols-2 gap-6 items-center py-12">
        <div>
          ...
          <p className="text-zinc-300 mt-3">Celebra los Noemia Days con descuentos imperdibles en productos seleccionados.</p>
